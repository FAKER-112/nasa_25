...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        '''
        try:
            numerical_cols= ['koi_tce_plnt_num', 'koi_fpflag_nt', 'koi_fpflag_ss', 
                            ...
                            'koi_srad', 'koi_srad_err1', 'koi_srad_err2', 'koi_smass', 'koi_smass_err1', 
                            'koi_smass_err2', 'koi_srho', 'koi_srho_err1', 'koi_srho_err2', 
                            'koi_model_snr', 'koi_max_sngle_ev', 'koi_max_mult_ev', 'koi_bin_oedp_sig', 
                            'ra', 'dec', 'koi_fwm_stat_sig', 'koi_fwm_sra', 'koi_fwm_sra_err', 
                            ...
                            'koi_dikco_mdec_err', 'koi_dikco_msky', 'koi_dikco_msky_err', 'koi_kepmag', 
